...
$searchfieldd=$_SESSION['technologiessearch'];
$limbafieldd=$_SESSION['technologieslimba'];
$domeniufieldd=$_SESSION['technologiesdomeniu'];
$domeniufieldd=$_SESSION['technologiesformat'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 tRANSITIONAL//EN" "http://www.w3.org/TR/xhtml1/dtd/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/shtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title> Technologies - Member </title>
...
<body>
	...
	if ($_POST['loginbtn']){
		$_SESSION['technologiessearch']=$_POST['searchfi'];
		$searchfieldd=$_SESSION['technologiessearch'];
		$_SESSION['technologieslimba']=$_POST['searchli'];
		$limbafieldd=$_SESSION['technologieslimba'];
		$_SESSION['technologiesdomeniu']=$_POST['searchdo'];
		$domeniufieldd=$_SESSION['technologiesdomeniu'];
		$_SESSION['technologiesformat']=$_POST['searchfo'];
		$formatfieldd=$_SESSION['technologiesformat'];
	...
	<div class=\"width\">
    		<ul>
				...
				<li class=\"start selected\"><a href=\"technologies.php\">Technologies</a></li>
    ...
    <div id=\"body\" class=\"width\">
	    ...
	    <article>
			...
			<h2>Welcome to the technologies news section! </h2>
        ...
        <aside class=\"sidebar\">
            ...
            <ul>	
                ...
                <li>
                    ...
                    <ul>
                    	<li class=\"text\">
                            <form action='./technologies.php' class=\"searchform\" method='post' >
                                <p>
									 <h4>Format
...
searchText=document.getElementById('searchField1').value;
	...
	if(document.getElementById('searchField1').value.length>0) {
		if(document.getElementById('searchFieldLimba').value.length>0) {
			...
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value)+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value)+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
				
			}else{
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value)+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value);
			}
		}
		else{
			
		if(document.getElementById('searchFieldDomeniu').value.length>0){
		url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value)+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
		}
		else {
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value);
			}
		}
	}
		else{
			...
			if(document.getElementById('searchFieldLimba').value.length>0) {
				...
				if(document.getElementById('searchFieldDomeniu').value.length>0){
					url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie\"+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value)+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
				}
				else{
					url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie\"+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value);
				}
		}
		else{
			if(document.getElementById('searchFieldDomeniu').value.length>0){
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie\"+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
			}else{
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20Technologie\";
			}
		}
		} 
