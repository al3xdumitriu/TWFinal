...
$searchfieldd=$_SESSION['tradesearch'];
$limbafieldd=$_SESSION['tradelimba'];
$domeniufieldd=$_SESSION['tradedomeniu'];
$domeniufieldd=$_SESSION['tradeformat'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 tRANSITIONAL//EN" "http://www.w3.org/TR/xhtml1/dtd/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/shtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title> Trade - Member </title>
...
<body>
	...
	if ($_POST['loginbtn']){
		$_SESSION['tradesearch']=$_POST['searchfi'];
		$searchfieldd=$_SESSION['tradesearch'];
		$_SESSION['tradelimba']=$_POST['searchli'];
		$limbafieldd=$_SESSION['tradelimba'];
		$_SESSION['tradedomeniu']=$_POST['searchdo'];
		$domeniufieldd=$_SESSION['tradedomeniu'];
		$_SESSION['tradeformat']=$_POST['searchfo'];
		$formatfieldd=$_SESSION['tradeformat'];
		$categorie="TRADE";
		$dbplatforma2="";
		if($searchfieldd!=""){
	...
	<div class=\"width\">
    		<ul>
				...
				<li class=\"start selected\"><a href=\"trade.php\">Trade</a></li>
    ...
    <div id=\"body\" class=\"width\">
	    ...
	    <article>
			...
			<h2>Welcome to the IT trade news section! </h2>
        ...
        <aside class=\"sidebar\">
            ...
            <ul>	
                ...
                <li>
                    ...
                    <ul>
                    	<li class=\"text\">
                            <form action='./trade.php' class=\"searchform\" method='post' >
                                <p>
									 <h4>Format
...
searchText=document.getElementById('searchField1').value;
	...
	if(document.getElementById('searchField1').value.length>0) {
		if(document.getElementById('searchFieldLimba').value.length>0) {
			...
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value)+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value)+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
				
			}else{
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value)+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value);
			}
		}
		else{
			
		if(document.getElementById('searchFieldDomeniu').value.length>0){
		url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value)+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
		}
		else {
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade%20\"+replaceAll(' ','%20',document.getElementById('searchField1').value);
			}
		}
	}
		else{
			...
			if(document.getElementById('searchFieldLimba').value.length>0) {
				...
				if(document.getElementById('searchFieldDomeniu').value.length>0){
					url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade\"+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value)+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
				}
				else{
					url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade\"+\"&language=\"+replaceAll(' ','%20',document.getElementById('searchFieldLimba').value);
				}
		}
		else{
			if(document.getElementById('searchFieldDomeniu').value.length>0){
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade\"+\"&site=\"+document.getElementById('searchFieldDomeniu').value;
			}else{
			url = \"https://webhose.io/search?token=67601ceb-c869-4f4c-9c75-cb2289765953&format=json&q=IT%20trade\";
			}
		}
		} 
