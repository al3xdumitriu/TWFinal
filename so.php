...
$searchfieldd=$_SESSION['sosearch'];
$limbafieldd=$_SESSION['solimba'];
$domeniufieldd=$_SESSION['sodomeniu'];
$formatfieldd=$_SESSION['soformat'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 tRANSITIONAL//EN" "http://www.w3.org/TR/xhtml1/dtd/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/shtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title> SO - Member </title>
...
<body>
	...
	if ($_POST['loginbtn']){
		$_SESSION['sosearch']=$_POST['searchfi'];
		$searchfieldd=$_SESSION['sosearch'];
		$_SESSION['solimba']=$_POST['searchli'];
		$limbafieldd=$_SESSION['solimba'];
		$_SESSION['sodomeniu']=$_POST['searchdo'];
		$domeniufieldd=$_SESSION['sodomeniu'];
		$_SESSION['soformat']=$_POST['searchfo'];
		$formatfieldd=$_SESSION['soformat'];
		$categorie="SO";
		$dbplatforma2="";
		if($searchfieldd!=""){
	...
	<div class=\"width\">
    		<ul>
        	    ...
        	    <li ><a href=\"engineering.php\">Engineering</a></li>
         	   	<li class=\"start selected\"><a href=\"so.php\">SO</a></li>
    ...
    <div id=\"body\" class=\"width\">
	    ...
	    <article>
			...
			<h2>Welcome to the operating system news section! </h2>
        ...
        <aside class=\"sidebar\">
            ...
            <ul>	
                ...
                <li>
                    ...
                    <ul>
                    	<li class=\"text\">
                            <form action='./so.php' class=\"searchform\" method='post' >
                                <p>
									 <h4>Format
